...
import sys
import traceback
from worker_consumer import create_consumer, consume_tile
from worker_producer import create_producer, send_result
from worker_prcoessor import process_image  # Updated to use new function

# ================= CONFIG =================
WORKER_ID = "worker-1"                # Change for each worker
